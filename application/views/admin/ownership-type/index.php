...
<?php
$buttoName = '';
if (!empty($editResult[0]->mast_ownershiptype_id)) {
    $frmaction = base_url() . "admin/OwnershipType/updateOwnType";
    $buttoName = 'Update Record';
    $BtnClass = 'btn btn-raised btn-warning';
} else {
    $frmaction = base_url() . "admin/OwnershipType/addOwnType";
            ...
            <div class="col-md-8 col-sm-8 col-lg-8 col-xm-8 offset-2">
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="card-title">Add Ownership Type</h3>
                    </div>
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtOwntypeName" class="form-control" required=""
                                       value="<?php if (!empty($editResult)) {
                                           echo $editResult[0]->ownershiptype_name;
                                       } else {
                            ...
                            <input type="hidden" name="hidden_id" value="<?php if (!empty($editResult)) {
                                echo $editResult[0]->mast_ownershiptype_id;
                            } ?>">
                            <!--------Hidden ID------->
                            <div class="form-group">
                                <div class="form-group">
                    ...
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <a class="btn btn-danger"
                               href="<?php echo base_url(); ?>admin/OwnershipType/deleteOwnType?id=<?php echo base64_encode($row->mast_ownershiptype_id); ?>"
