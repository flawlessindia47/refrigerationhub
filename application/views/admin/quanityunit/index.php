...
<?php
$buttoName = '';
if (!empty($editResult[0]->mst_qty_id)) {
    $frmaction = base_url() . "admin/QuantityUnit/updateQuantity";
    $buttoName = 'Update Record';
    $BtnClass = 'btn btn-raised btn-warning';
} else {
    $frmaction = base_url() . "admin/QuantityUnit/addQuantity";
            ...
            <div class="col-md-8 col-sm-8 col-lg-8 col-xm-8 offset-2">
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="card-title">Add Quanity Unit</h3>
                    </div>
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtQuanityUnit" class="form-control" required=""
                                       value="<?php if (!empty($editResult)) {
                                           echo $editResult[0]->qty_name;
                                       } else {
                                           echo set_value('txtQuanityUnit');
                                       } ?>">
                            </div>
                            <!--------Hidden ID------->
                            <input type="hidden" name="hidden_id" value="<?php if (!empty($editResult)) {
                                echo $editResult[0]->mst_qty_id;
                            } ?>">
                            <!--------Hidden ID------->
                            <div class="form-group">
                                <div class="form-group">
                    ...
                    <tr>
                        ...
                        <?php if($user_type==1):?>
                            <td><?php if ($row->delStatus == 'yes') { ?>
                                    <a href="<?php echo base_url(); ?>admin/QuantityUnit/Restore?id=<?php echo base64_encode($row->mst_qty_id); ?>"
                        ...
                        <td class="center">
                            <a href="<?php echo base_url(); ?>admin/QuantityUnit?id=<?php echo base64_encode($row->mst_qty_id); ?>"
                               class="btn btn-primary">
                                Edit
                            </a>
                            <a class="btn btn-danger"
                               href="<?php echo base_url(); ?>admin/QuantityUnit/delete?id=<?php echo base64_encode($row->mst_qty_id); ?>"
