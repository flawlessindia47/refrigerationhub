            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Lead Manage</h3>
                    </div>
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header">
                       <h3 class="card-title">All General Lead
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            foreach ($list as $row): ?>
                                <tr>
                                    ...
                                    <td><?php echo $row->pbr_email ?></td>
                                    <td><?php echo $row->pbr_mobile ?></td>
                                    <td><?php echo $row->pbr_productname ?></td>
                                    <td><?php echo $row->pbr_description ?></td>
                                    
                                    
                                    <?php if ($user_type == 1) { ?>
                                        <td><?php if ($row->delStatus == 'yes') { ?>
                                                <a href="<?php echo base_url(); ?>admin/Material/Restorepsource?id=<?php echo base64_encode($row->product_id); ?>"
                                    ...
                                    <td><?php if ($row->status == 'New') {
                                            ...
                                            echo "<label class='badge badge-warning' >Close<label>";
                                        } ?> </td>
                                    <td class="">
                                        <a href="<?php echo base_url(); ?>admin/Manage/pbredit?id=<?php echo base64_encode($row->pbr_id); ?>"
                                           class="btn btn-primary">
                                            Edit
                                        </a>
                                         <a href="<?php echo base_url(); ?>admin/Manage/assignlead?id=<?php echo base64_encode($row->pbr_id); ?>"
                                           class="btn btn-warning">
                                            Assign Lead
                                        </a>

                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Manage/deletepbr?id=<?php echo base64_encode($row->pbr_id); ?>"
