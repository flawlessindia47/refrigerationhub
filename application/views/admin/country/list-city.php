                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">All User List <a style="float:right;"
                                                                href="<?php echo base_url(); ?>admin/Country/City">Add
                                City</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            foreach ($list as $row): ?>
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <?php if($user_type==1){?>
                                            <a href="<?php echo base_url(); ?>admin/Country/cityRestore?id=<?php echo base64_encode($row->city_id); ?>"
                                               class="btn btn-success">
                                                Restore
                                            </a>
                                        <?php }?>
                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Country/deleteCity?id=<?php echo base64_encode($row->city_id); ?>"
                                           onclick="return confirm('Would you want to delete City Name  ?');">Delete</a>
