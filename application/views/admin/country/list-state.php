                            ...
                            foreach ($list as $row): ?>
                                ...
                                <?php if($user_type==1){?>
                                    ...
                                    <td class="">
                                        ...
                                        <?php if($user_type==1){?>
                                        <a href="<?php echo base_url(); ?>admin/Country/stateRestore?id=<?php echo base64_encode($row->state_id); ?>"
                                           class="btn btn-success">
                                            Restore
                                        </a>
                                        <?php }?>
                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Country/deleteState?id=<?php echo base64_encode($row->state_id); ?>"
                                           onclick="return confirm('Would you want to delete State Name  ?');">Delete</a>
