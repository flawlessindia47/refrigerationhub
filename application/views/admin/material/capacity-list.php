            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Capacity Unit List</h3>
                    </div>
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">All Capacity Unit List <a style="float:right;"
                                                                   href="<?php echo base_url(); ?>admin/Material/capacity">Add
                                Capacity Unit </a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <?php if ($user_type == 1) { ?>
                                        <td><?php if ($row->delStatus == 'yes') { ?>
                                                <a href="<?php echo base_url(); ?>admin/Material/Restorecapacityunit?id=<?php echo base64_encode($row->cu_id); ?>"
                                                   onclick="return confirm('Would you want to restore capacity unit ?');"
                                    ...
                                    <td class="">
                                        <a href="<?php echo base_url(); ?>admin/Material/capacity?id=<?php echo base64_encode($row->cu_id); ?>"
                                           class="btn btn-primary">
                                            Edit
                                        </a>

                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Material/deletecapacity?id=<?php echo base64_encode($row->cu_id); ?>"
                                           onclick="return confirm('Would you want to delete capacity Unit  ?');">Delete</a>
                                    </td>
