    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">All Measure List <a style="float:right;"
                                                                   href="<?php echo base_url(); ?>admin/Material/measureunit">Add
                                Measure Unit </a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <?php if ($user_type == 1) { ?>
                                        <td><?php if ($row->delStatus == 'yes') { ?>
                                                <a href="<?php echo base_url(); ?>admin/Material/Restoremeasureunit?id=<?php echo base64_encode($row->um_id); ?>"
                                                   onclick="return confirm('Would you want to restore unit ?');"
                                    ...
                                    <td class="">
                                        <a href="<?php echo base_url(); ?>admin/Material/measureunit?id=<?php echo base64_encode($row->um_id); ?>"
                                           class="btn btn-primary">
                                            Edit
                                        </a>

                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Material/deletemeasureunit?id=<?php echo base64_encode($row->um_id); ?>"
                                           onclick="return confirm('Would you want to delete unit record ?');">Delete</a>
                                    </td>
