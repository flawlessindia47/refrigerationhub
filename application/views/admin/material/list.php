    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">All Material List <a style="float:right;"
                                                                    href="<?php echo base_url(); ?>admin/Material">Add
                                Material</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <?php if ($user_type == 1) { ?>
                                        <td><?php if ($row->delStatus == 'yes') { ?>
                                                <a href="<?php echo base_url(); ?>admin/Material/Restore?id=<?php echo base64_encode($row->mst_material_id); ?>"
                                                   onclick="return confirm('Would you want to restore material ?');"
                                    ...
                                    <td class="">
                                        <a href="<?php echo base_url(); ?>admin/Material?id=<?php echo base64_encode($row->mst_material_id); ?>"
                                           class="btn btn-primary">
                                            Edit
                                        </a>

                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Material/deleteMaterial?id=<?php echo base64_encode($row->mst_material_id); ?>"
                                           onclick="return confirm('Would you want to delete material record ?');">Delete</a>
                                    </td>
