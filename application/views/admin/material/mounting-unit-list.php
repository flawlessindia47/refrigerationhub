            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Mounting Unit List</h3>
                    </div>
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">All Mounting Unit List <a style="float:right;"
                                                                        href="<?php echo base_url(); ?>admin/Material/mounting">Add Mounting Unit</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <?php if ($user_type == 1) { ?>
                                        <td><?php if ($row->delStatus == 'yes') { ?>
                                                <a href="<?php echo base_url(); ?>admin/Material/Restoremounting?id=<?php echo base64_encode($row->mou_id); ?>"
                                    ...
                                    <td class="">
                                        <a href="<?php echo base_url(); ?>admin/Material/mounting?id=<?php echo base64_encode($row->mou_id); ?>"
                                           class="btn btn-primary">
                                            Edit
                                        </a>

                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Material/deletemounting?id=<?php echo base64_encode($row->mou_id); ?>"
