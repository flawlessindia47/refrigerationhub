...
<?php
$buttoName = '';
if (!empty($editResult[0]->psouce_id)) {
    $frmaction = base_url() . "admin/Material/updatepsource";
    $buttoName = 'Save Changes';
    $BtnClass = 'btn btn-raised btn-warning';
} else {
    $frmaction = base_url() . "admin/Material/addpowersource";
    $buttoName = 'Add';
            ...
            <div class="col-md-8 col-sm-8 col-lg-8 col-xm-8 offset-2">
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="card-title">Add Power Source</h3>
                    </div>
                    <div class="card-body">
