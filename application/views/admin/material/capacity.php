...
<?php
$buttoName = '';
if (!empty($editResult[0]->cu_id)) {
    $frmaction = base_url() . "admin/Material/updatecapacity";
    $buttoName = 'Save Changes';
    $BtnClass = 'btn btn-raised btn-warning';
} else {
    $frmaction = base_url() . "admin/Material/addcapacity";
    $buttoName = 'Add Capacity';
            ...
            <div class="col-md-8 col-sm-8 col-lg-8 col-xm-8 offset-2">
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="card-title">Add Capacity Unit</h3>
                    </div>
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtCapacity" class="form-control" required=""
                                       value="<?php if (!empty($editResult)) {
                                           echo $editResult[0]->cu_name;
                                       } else {
                                           echo set_value('txtCapacity');
                                       } ?>">
                            </div>
                            <!-----Hidden Value----->
                            <input type="hidden" name="hidden_id" class="form-control"
                                   value="<?php if (!empty($editResult)) {
                                       echo $editResult[0]->cu_id;
                                   } ?>">
                            <!-----Hidden Value----->
                            <div class="form-group">
                                <div class="form-group">
