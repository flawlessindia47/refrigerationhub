...
$buttoName = '';
if (!empty($editResult[0]->mst_material_id)) {
    $frmaction = base_url() . "admin/Material/updateMaterial";
    $buttoName = 'Save Changes';
    $BtnClass = 'btn btn-raised btn-warning';
} else {
    $frmaction = base_url() . "admin/Material/addMaterial";
    $buttoName = 'Add Material';
                    ...
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                <label>Name </label>
                                <input type="text" name="txtmaterial" class="form-control" required=""
                                       value="<?php if (!empty($editResult)) {
                                           echo $editResult[0]->m_name;
                                       } else {
                                           echo set_value('txtmaterial');
                                       } ?>">
                            </div>
                            <!-----Hidden Value----->
                            <input type="hidden" name="hidden_id" class="form-control"
                                   value="<?php if (!empty($editResult)) {
                                       echo $editResult[0]->mst_material_id;
                                   } ?>">
                            <!-----Hidden Value----->
                            <div class="form-group">
                                <div class="form-group">
