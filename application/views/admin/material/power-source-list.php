            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Power Source List</h3>
                    </div>
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">All Power Source List <a style="float:right;"
                                                                   href="<?php echo base_url(); ?>admin/Material/powersource">Add Power Source</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <?php if ($user_type == 1) { ?>
                                        <td><?php if ($row->delStatus == 'yes') { ?>
                                                <a href="<?php echo base_url(); ?>admin/Material/Restorepsource?id=<?php echo base64_encode($row->psouce_id); ?>"
                                    ...
                                    <td class="">
                                        <a href="<?php echo base_url(); ?>admin/Material/powersource?id=<?php echo base64_encode($row->psouce_id); ?>"
                                           class="btn btn-primary">
                                            Edit
                                        </a>

                                        <a class="btn btn-danger"
                                           href="<?php echo base_url(); ?>admin/Material/deletepsource?id=<?php echo base64_encode($row->psouce_id); ?>"
